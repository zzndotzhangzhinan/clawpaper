...
## ----warning=FALSE-------------------------------------------------------------------------
ex1.2fdr = data.frame(pivec, CLAW = fdr.new, BH=fdr.bh, BH_Storey=fdr.sbh,
                      AdaDetect = fdr.ad, AdaDetect_Storey = fdr.sad)
ex1.2fdr = melt(ex1.2fdr,id="pivec")
colnames(ex1.2fdr) = c("pi","METHOD","value")


ex1.2tdp = data.frame(pivec, CLAW = tdp.new, BH=tdp.bh, BH_Storey=tdp.sbh,
                      AdaDetect = tdp.ad, AdaDetect_Storey = tdp.sad)
...
grid_arrange_shared_legend(line1.4fdr,line1.1fdr,line1.2fdr,
                           line1.4tdp,line1.1tdp,line1.2tdp,nrow=2,ncol=3,position = "top")
