...
#' 
#' 1. 1D case block mu change
#' m = 3000
#' pi = 0.6 for [201,350], [1501,1650] 
#' pi = 0.3 for [801,1000], [2101,2300] 
#' pi = 0.02 otherwise
#' f0=N(0,1), f1=N(mu,1)
## ----warning=FALSE-------------------------------------------------------------------------
m = 3000
...
for (k in 1:length(rvec) ){
  ...
  for (l in 1:200){
    ...
    y = rnorm(m,0,1) #y = (ts-noi)/sqrt(1.01)
...
#' 
#' 
#' 2. 1D case block pi change
#' m = 3000
#' pi = 2pp for [201,350], [1501,1650]
#' pi = pp for [801,1000], [2101,2300]
#' pi = 0.02 otherwise
#' f0=N(0,1), f1=N(-2.5,1) for [1,1500]; f1=N(3.6,1.5^2) for [1501,3000]
## ----warning=FALSE-------------------------------------------------------------------------
m = 3000
al = 0.05
f0 = c(0,1)
...
#' 
#' 
#' 3. 1D case sin mu change
#' m = 3000
#' pi = 0.4*[1+sin(0.02t)] for [201,500], [1501,1800], [801,1100], [2101,2400]
#' pi = 0.02 otherwise
#' f0=N(0,1), f1=N(nu,1) where  nu=mu+0.15sin(0.6t) 
## ----warning=FALSE-------------------------------------------------------------------------
m = 3000
al = 0.05
f0 = c(0,1)
